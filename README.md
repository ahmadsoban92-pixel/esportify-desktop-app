...
Bash
git clone https://github.com/your-username/esportify-desktop-app.git
...
Note: On your very first run, the system will automatically launch the First-Run Setup screen to securely register and verify the Master Admin account.
